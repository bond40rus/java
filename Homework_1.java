...
public class Homework_1 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\n# 5");
        System.out.println(Arrays.toString(createArray(3, 3))); // 3, 3, 3, 3, 3
        System.out.println(); 
      ...
      ///////////////// **
        ...
        System.out.println(Arrays.toString(correctArr(arr2)));
    ...
    private static int[] RandomArray(int lenArray){
        int[] list = new int  [lenArray];
        Random rnd = new Random();
        
        for (int i = 0; i < lenArray; i++)
        {
            list[i] = rnd.nextInt(2 );
        }
       return list;
    }
    ...
    private static int[] correctArr(int[] array){
        int len = array.length;
        int[] res = new int[len];
        for (int i = 0; i < len; i++){
            if(array[i] < 6){
